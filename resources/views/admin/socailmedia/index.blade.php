...
<div class="aiz-titlebar text-left mt-2 mb-3">
    <div class="row align-items-center">
        <div class="col-auto">
            <h1 class="h3">{{('All Social Media')}}</h1>
        </div>
...
<div class="card">
    <form class="" id="sort_products" action="" method="GET">
        <div class="card-header row gutters-5">
            <div class="col">
                <h5 class="mb-md-0 h6">{{ ('All Socail Media') }}</h5>
            </div>
                    ...
                    <tr>
                            ...
                            <td>
                                <div class="form-group d-inline-block">
                                    <label class="aiz-checkbox">
                                        <div class="col">
                                            <span class="text-muted text-truncate-2">{{$social->a_name_soical }}</span>
                                        </div>
                                    </label>
                                </div>
                            </td>
                            <td>
                                <div class="form-group d-inline-block">
                                    <label class="aiz-checkbox">
                                        <div class="col">
                                            <span class="text-muted text-truncate-2">{{$social->link_page }}</span>
                                        </div>
                                    </label>
                                </div>
                            </td>
                            ...
                            <td class="text-right">
                                <a class="pull-left" href="{{route('social.edit', ['id'=>$social->id, 'lang'=>env('DEFAULT_LANGUAGE')] )}}" title="{{ ('Edit') }}">
